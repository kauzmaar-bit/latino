...
const abbreviationsData = [
    ...
    { cat: 'mods', sigla: 'SF', en: 'Sharp Fortitude', es: 'Fortaleza Afilada (Sharp Fortitude)', desc: 'Módulo de Armadura vital en late-game. Aumenta masivamente la Salud y la Regeneración del Muro (Wall), y hace que los enemigos sufran más daño por las espinas del muro tras cada golpe.' },
